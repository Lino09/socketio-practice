...
wikiNs.addRoom(new Room(0,'New Articles','Wiki')).addRoom(new Room(1,'Editors','Wiki')).addRoom(new Room(2,'Other','Wiki'));

mozNs.addRoom(new Room(0,'Firefox','Mozilla')).addRoom(new Room(1,'SeaMonkey','Mozilla')).addRoom(new Room(2,'SpiderMonkey','Mozilla')).addRoom(new Room(3,'Rust','Mozilla'));

linuxNs.addRoom(new Room(0,'Debian','Linux')).addRoom(new Room(1,'Red Hat','Linux')).addRoom(new Room(2,'MacOs','Linux')).addRoom(new Room(3,'Kernel Development','Linux'));
